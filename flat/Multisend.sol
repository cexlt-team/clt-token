...
contract Multisend is Ownable {
  ...
  function multiSendCoinWithSameValue(address _tokenAddress, address[] memory _to, uint _value) payable public {
    coinSendSameValue(_tokenAddress, _to, _value);
  }

  function multiSendCoinWithDifferentValue(address _tokenAddress, address[] memory _to, uint[] memory _value) payable public {
  ...
  function drop(address _tokenAddress, address[] memory _to, uint _value) payable public {
    coinSendSameValue(_tokenAddress, _to, _value);
  }
}
